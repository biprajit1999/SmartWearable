...
const char Thing1[] = "Heart Rate Sensor"; //Pulse
const char Property1[] = "HeartRate";

const char Thing2[] = "Temperature Sensor"; // LM35 Body Temperature
const char Property2[] = "Temperature";

const char Thing3[] = "Humidity Sensor"; // DhT11 (Humidity)
const char Property3[] = "Sweat";

const char Thing4[] = "Light Sensor"; // LDR (Light)
const char Property4[] = "LDR";

const char Thing5[] = "Position Sensor"; // MPU6050
